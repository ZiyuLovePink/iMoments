...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    _navigationController = [[STNavigationViewController alloc] initWithRootViewController:rootViewController];
    _navigationController.navigationBar.barStyle = UIBarStyleBlackTranslucent;
    //[[UINavigationBar appearance] setTintColor:[UIColor colorWithRed:42/255.0 green:47/255.0 blue:52/255.0 alpha:1]];
    //navigationController.navigationBar.tintColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"nav-bar-background"]];
